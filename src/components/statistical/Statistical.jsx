...
const Statistical = () => {
    ...
    const headers = ["MSSV", "Full Name", "Email", "Gender", "Birthday", "Phone", "Class", "Year study", "Teacher", "Internship Name", "Course Internship", "Start day", "End day", "Attendance", "Score", "Report"];
